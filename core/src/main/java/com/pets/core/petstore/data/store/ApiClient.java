...
import com.pets.core.petstore.data.store.auth.HttpBasicAuth;
import com.pets.core.petstore.data.store.auth.ApiKeyAuth;
import com.pets.core.petstore.data.store.auth.OAuth;
import com.pets.core.petstore.data.store.auth.OAuth.AccessTokenListener;
import com.pets.core.petstore.data.store.auth.OAuthFlow;
